        ...
        >
            ...
            <div className='grid gap-12  grid-cols-1 md:grid-cols-2 lg:grid-cols-2  '>
                {projects.map((project) => (
                    <div
                        ...
                        <div className='p-4'>
                            <img src={project.image} alt={project.title} className='w-full  object-cover rounded-xl ' />
                        </div>
                        <div className='p-6'>
            ...
            {selectedProject && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
                    <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl relative max-h-[90vh] flex flex-col">
                        <button
                            onClick={handleCloseModal}
                            className="absolute top-2 right-3 z-20 text-white text-3xl font-bold hover:text-purple-500"
